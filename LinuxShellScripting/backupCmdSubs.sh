# Title: Backup files using bash scripting techniques - use of command substitution
# Author: Ahmed M Khan
# Date Created: 7/03/21
# Date Modified: 7/03/21
# Description : This program shows use of command substitution to print date in the log file
